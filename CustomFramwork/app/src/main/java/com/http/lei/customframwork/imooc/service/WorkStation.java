...
import com.http.lei.customframwork.imooc.HttpRequestProvider;
...
public class WorkStation {
    ...
    public void doHttpRequest(MoocRequest request) {
        ...
        try {
            ...
            System.out.print("uri:"+httpRequest.getUri()+" method:"+httpRequest.getMethod());
            System.out.print("2 uri:" + request.getUrl() + " method:" + request.getMethod());
        } catch (IOException e) {
            e.printStackTrace();
        }
